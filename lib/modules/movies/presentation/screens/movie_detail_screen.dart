...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      buildWhen: (previous, current) {
        return previous.movieDetails != current.movieDetails;
      },
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      buildWhen: (previous, current) {
        return previous.moviesRecommendation != current.moviesRecommendation;
      },
      builder: (context, state) {
        switch (state.moviesRecommendationState) {
          ...
          case RequestState.failure:
            return SliverToBoxAdapter(
              child: Center(
                child: Text(state.moviesRecommendationErrorMessage),
              ),
            );
        }
      },
